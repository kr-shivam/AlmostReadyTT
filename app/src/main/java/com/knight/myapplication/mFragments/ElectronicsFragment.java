...
public class ElectronicsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.frag_electronics,container, false);
        ListView lv = (ListView) rootView.findViewById(R.id.electronicsListView);
        CustomAdapter adapter = new CustomAdapter(this.getActivity(),getElectronicsMall());
    ...
    private ArrayList<MallList> getElectronicsMall(){
